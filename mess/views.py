...
class MessagesListView(mixins.LoginRequiredMixin, CheckModeratorMixin, ListView):
    model = MessageInfo
    paginate_by = 4
...
class MessageChangeActivityView(mixins.LoginRequiredMixin, OwnerOrStaffPermissionMixin, DeleteView):
    model = MessageInfo
