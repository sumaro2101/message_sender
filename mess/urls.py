...
from mess.views import MessagesListView, main_list, MessageCreateView, MessageUpdateView, MessageChangeActivityView
...
urlpatterns = [
    ...
    path('messages/delete/<slug:slug>', MessageChangeActivityView.as_view(), name='delete_mess'),
]