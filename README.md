...
- Ваш списко клиентов будет пуст, нажмите "Добавить клиента".
...
- Вас перекинет на "Центр сообщений" для выбора сообщения для рассылки.
- Нажмите на зеленую кнопку "Начать рассылку" которая расположена на карте сообщения.
...
а так же "Выбор клиентов" там где отображается список ативных клиентов.
- Выберете клиентов и настройки для рассылки и нажмите кнопку "Принять".
- После создания рассылки вы попадаете в страницу текущей созданной рассылки
...
!!! АДМИНИСТРАТОР !!!
- Так же если зайти с правами доспута Администратора возможны дополнительные возможности.
