...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('users', '0002_alter_navbarlist_options_alter_sublist_options'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('men', 'Мужчина'), ('women', 'Женщина'), (None, 'Не выбрано')], default=None, null=True, verbose_name='пол')),
