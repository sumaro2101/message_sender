...
def _parse_interval_to_intervalschedule(interval: timedelta) -> IntervalSchedule:
    ...
    Raises:
        ...
        ObjectDoesNotExist: Исключение если не получилось получить не одного рассписания
...
def _core_task(name: str,
    ...
    if interval:
        ...
        interval : IntervalSchedule = _parse_interval_to_intervalschedule(interval)
